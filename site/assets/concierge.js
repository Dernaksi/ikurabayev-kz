...
(function () {
  ...
  var CONSOLE = {
    ...
    kk: {
      mode: "Дереккөз режимі: тек ашық деректер",
      flags: ["Прототиптік интерфейс", "Тек жергілікті", "Жеке деректерсіз"],
      proto: "Нақты AI интеграциясы қосылмаған",
      q: "СҰРАУ",
      r: "ЖАУАП"
    }
  };
  ...
  var ANSWERS = {
    ru: [
      ...
      { k: ["кто ", "чем заним", "о нём", "о нем", "расскажи о", "кем работ"], a: "Курабаев Искандер Казбекович — исследователь в области электротехники, специалист по энергоэффективности, инженер прикладных измерений, PhD и сертифицированный энергоаудитор. Старший преподаватель КазАТИУ им. С. Сейфуллина." },
      { k: ["сертифик", "энергоаудитор", "срок действ"], a: "Курабаев Искандер Казбекович — сертифицированный энергоаудитор в области энергосбережения и повышения энергоэффективности. Сертификат выдан 14 августа 2026 года и действителен до 6 августа 2029 года. Номер и другие реквизиты документа намеренно не публикуются." },
    ...
    en: [
      ...
      { k: ["who ", "what does", "about him", "tell me about", "his job"], a: "Iskander Kurabayev is an electrical engineering researcher, energy-efficiency specialist, applied measurement engineer, PhD, and certified energy auditor. He is a Senior Lecturer at S. Seifullin Kazakh Agrotechnical Research University." },
      { k: ["certification", "certificate", "certified", "valid until"], a: "Iskander Kurabayev is a certified energy auditor in the field of energy saving and energy efficiency improvement. The certificate was issued on 14 August 2026 and is valid until 6 August 2029. Its number and other document details are intentionally not published." },
      ...
      { k: ["ai", "stm", "lab", "neural"], a: "The AI Engineering Lab has two in-development tracks: “AI Energy Auditor” — a concept for AI-assisted energy audit with traceable reasoning, and “STM32 / measurement lab” — hardware signal capture and a test bench. These are roadmap directions, not launched products." },
    ...
    kk: [
      { k: ["сәлем", "салем", "кім сен", "не істей ал"], a: "Сәлеметсіз бе! Мен Қорабаев Ескендір Қазбекұлының ашық профилінің көмекшісімін. Әдіс, зерттеулер, жарияланымдар, патенттер немесе AI Engineering Lab даму картасы туралы сұраңыз." },
      { k: ["кім ", "немен айнал", "ол туралы", "жұмысы"], a: "Қорабаев Ескендір Қазбекұлы — электротехника саласындағы зерттеуші, энергия тиімділігі маманы, қолданбалы өлшеу инженері, PhD және сертификатталған энергоаудитор. С. Сейфуллин атындағы Қазақ агротехникалық зерттеу университетінің аға оқытушысы." },
      { k: ["сертификаттал", "сертификат", "жарамды"], a: "Қорабаев Ескендір Қазбекұлы — энергия үнемдеу және энергия тиімділігін арттыру саласындағы сертификатталған энергоаудитор. Сертификат 2026 жылғы 14 тамызда берілді және 2029 жылғы 6 тамызға дейін жарамды. Оның нөмірі мен құжаттың өзге деректемелері әдейі жарияланбайды." },
      ...
      { k: ["ai", "ии", "auditor", "stm", "зертхана", "нейрож"], a: "AI Engineering Lab-та әзірленудегі екі бағыт бар: «AI Energy Auditor» — қорытындылары қадағаланатын, AI көмегімен жүргізілетін энергоаудит тұжырымдамасы және «STM32 / өлшеу зертханасы» — аппараттық сигнал жинау және стенд. Бұл — даму картасы, іске қосылған өнім емес." },
      { k: ["жарияла", "мақала", "жұмыс", "doi", "зерттеу"], a: "Жарияланған жұмыстар (2019–2023) бейтарабы оқшауланған және жерге тұйықталмаған айнымалы ток желілеріндегі оқшаулау параметрлеріне арналған: әдістің математикалық сипаттамасы, зертханалық эксперименттер, жұмыс істеп тұрған экскаватордағы апробация және қателікті бағалау. Бірнеше жұмыстың DOI-ы тексерілген («Таңдаулы жарияланымдар» бөлімін қараңыз)." },
      ...
      { k: ["білім", "phd", "диплом", "оқыд"], a: "Білімі: «Электротехникалық кешендер мен жүйелер» бойынша PhD, электр энергетикасы бойынша техника ғылымдарының магистрі және өнеркәсіптік электрмен жабдықтау бойынша инженер-электрик." },
