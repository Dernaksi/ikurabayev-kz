...
(function () {
  ...
  var ANSWERS = {
    ...
    kk: [
      ...
      { k: ["кім ", "немен айнал", "ол туралы", "жұмысы"], a: "Қорабаев Ескендір Қазбекұлы — электртехника саласының зерттеушісі, энергия тиімділігі маманы, қолданбалы өлшеу инженері, PhD және сертификатталған энергоаудитор. С. Сейфуллин атындағы Қазақ агротехникалық зерттеу университетінің аға оқытушысы." },
      { k: ["сертификаттал", "сертификат", "жарамды"], a: "Қорабаев Ескендір Қазбекұлы — энергия үнемдеу және энергия тиімділігін арттыру саласындағы сертификатталған энергоаудитор. Сертификат 2026 жылғы 14 тамызда берілді және 2029 жылғы 6 тамызға дейін жарамды. Оның нөмірі мен басқа құжат деректері әдейі жарияланбайды." },
      ...
      { k: ["ai", "ии", "auditor", "stm", "зертхана", "нейрож"], a: "AI Engineering Lab-та әзірленудегі екі бағыт бар: «AI Energy Auditor» — қорытындылары бақыланатын ИИ-ассистенттік энергоаудит тұжырымдамасы және «STM32 / өлшеу зертханасы» — аппараттық сигнал жинау және стенд. Бұл — даму картасы, іске қосылған өнім емес." },
